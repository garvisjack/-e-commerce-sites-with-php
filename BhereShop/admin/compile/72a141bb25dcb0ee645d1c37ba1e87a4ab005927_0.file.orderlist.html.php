<?php
/* Smarty version 3.1.30, created on 2017-03-23 14:17:09
  from "F:\wamp\www\Bhere shop\admin\template\order\orderlist.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58d3d8e5305085_55163242',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '72a141bb25dcb0ee645d1c37ba1e87a4ab005927' => 
    array (
      0 => 'F:\\wamp\\www\\Bhere shop\\admin\\template\\order\\orderlist.html',
      1 => 1489917722,
      2 => 'file',
    ),
  ),
...
function content_58d3d8e5305085_55163242 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li style='float:right;'>
                    <input type="text" name="ordercode" class="input" style="width:150px;height:30px;display:inline-block;font-size:11px;" value="" />
...
<br/><?php echo $_smarty_tpl->tpl_vars['value']->value['overtime'];?>
</td>
                    ...
                    <td><?php if ($_smarty_tpl->tpl_vars['value']->value['order_status'] == '0') {?><strong style="color:red">待付款</strong>
                        <?php } elseif ($_smarty_tpl->tpl_vars['value']->value['order_status'] == '1') {?><strong style="color:#ff4500">已发货</strong>
                        <?php } else { ?>
                        <strong style="color:green">已完成</strong>
                        <?php }?></td>
                    <td><div class="button-group">
                        <a class="button border-main" href="?c=order&a=editororder&order=<?php echo $_smarty_tpl->tpl_vars['value']->value['order_num'];?>
