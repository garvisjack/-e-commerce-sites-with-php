<?php
/* Smarty version 3.1.30, created on 2017-03-22 11:12:29
  from "C:\wamp\www\Bhere shop\admin\template\autogoods\autogoods.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58d25c1d38e484_23254342',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bafddb993353be712a2455f91c1d4871b6c7cae9' => 
    array (
      0 => 'C:\\wamp\\www\\Bhere shop\\admin\\template\\autogoods\\autogoods.html',
      1 => 1489140084,
      2 => 'file',
    ),
  ),
...
function content_58d25c1d38e484_23254342 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="get" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">BhereShop-商品自动上下架</strong></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-yellow icon-plus-square-o" href="?c=autogoods&a=add"> 添加商品</a> </li>
        <li>搜索：</li>
        <li>
...
" />
            ...
            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['input'];?>
</td>
            <td style="display:block;width:270px;height:55px;overflow:hidden;line-height:60px;margin-left: auto"><?php echo $_smarty_tpl->tpl_vars['value']->value['output'];?>
</td>
            <td><div class="button-group">
                    <a class="button border-main" href="?c=autogoods&a=editor">
                        <span class="icon-edit"></span> 上架
                    </a>
                    <a class="button border-main" href="?c=autogoods&a=editor">
                        <span class="icon-edit"></span> 下架
                    </a>
                    <a class="button border-main" href="?c=autogoods&a=editor&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
">
