<?php
/* Smarty version 3.1.30, created on 2017-03-23 14:25:18
  from "F:\wamp\www\Bhere shop\admin\template\comment\comment_editor.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58d3dace784408_79794194',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c521d77ac6d73d2163beefa571b31d5c316736cf' => 
    array (
      0 => 'F:\\wamp\\www\\Bhere shop\\admin\\template\\comment\\comment_editor.html',
      1 => 1489052690,
      2 => 'file',
    ),
  ),
...
function content_58d3dace784408_79794194 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_time')) require_once 'F:\\wamp\\www\\Bhere shop\\libs\\plugins\\modifier.time.php';
if (!is_callable('smarty_modifier_checkarr')) require_once 'F:\\wamp\\www\\Bhere shop\\libs\\plugins\\modifier.checkarr.php';
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
" name="user_name" readonly/>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="radio" name="isemail" VALUE="0" checked/>邮件通知
                    <div class="tips"></div>
                </div>
            </div>
            <div class="clear"></div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <button class="button bg-main icon-check-square-o" type="submit" name="send_email"> 重发邮件</button>
                </div>
            </div>
        </form>
    </div>
