<?php
/* Smarty version 3.1.30, created on 2017-04-02 18:05:31
  from "/usr/lamp/apache2/htdocs/admin/template/role/role.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58e0ccebe3eed3_22367212',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f2199d34de9f5cb2458af461ced4fd833deb765b' => 
    array (
      0 => '/usr/lamp/apache2/htdocs/admin/template/role/role.html',
      1 => 1491117048,
      2 => 'file',
    ),
  ),
...
function content_58e0ccebe3eed3_22367212 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<body>
<form method="post" action="?c=role&a=search" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">BhereShop-角色管理</strong></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li style="margin-top: -2px"> <a class="button border-yellow icon-plus-square-o" href="?c=role&a=add"> 添加角色</a> </li>
        <li>
		    <li>
          ...
          <li style="margin-top:-2px;"><input type="submit" name="submit" value="搜索角色" class="button border-main icon-search" id="search" style="margin-top: 0px;"></li>
        </li>
      </ul>
    </div>
...
function DelSelect(){
	...
	if (Checkbox){
		...
		$.getJSON("?c=role&a=deleteAll",{id:id_array},function(msg){
          if(msg==1){
               
              location.href='?c=role&a=select';
            }else{
...
function go(){
    ...
    location.href = "?c=role&a=select&p="+page.value+"#spot";
}
<?php echo '</script'; ?>
>
</body>
