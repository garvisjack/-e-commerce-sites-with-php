<?php
/* Smarty version 3.1.30, created on 2017-03-31 03:00:37
  from "/usr/lamp/apache2/htdocs/template/pi/logistics.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58dd55d52ff1e3_71744433',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a32fc56f8456373d535cddf243da1c70445976bb' => 
    array (
      0 => '/usr/lamp/apache2/htdocs/template/pi/logistics.html',
      1 => 1490774946,
      2 => 'file',
    ),
  ),
...
function content_58dd55d52ff1e3_71744433 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html>
	<head>
		<meta charset="utf-8">
					...
					<div class="main-wrap mt15">
						...
						<div class="form-list tab-switch personal-wrap-show">
								...
								<div class="control-group clearfix"style="margin-top: 30px;" >
                                    <h3>所选快递 :<?php echo $_smarty_tpl->tpl_vars['ship']->value;?>
</h3>
                                    <h3>快递单号 :<?php echo $_smarty_tpl->tpl_vars['lcode']->value;?>
</h3>
                                    <form action="?c=pi&a=logistics" method="post">
                                        <dl class="mydl">
                                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['info']->value, 'value');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['value']->value) {
?>
                                            <dt>
                                                <span style="color:#e33131;font-weight: bold;">
                                                    <?php echo $_smarty_tpl->tpl_vars['value']->value['AcceptTime'];?>

                                                </span>
                                            </dt>
                                            <dd><?php echo $_smarty_tpl->tpl_vars['value']->value['AcceptStation'];?>
</dd>
                                            <?php
}
}
