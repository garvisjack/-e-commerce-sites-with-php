 ...
 * </pre>
 *
 * @link     http://www.smarty.net/manual/en/language.function.html.selectPage.date.php {html_select_date}
...
function smarty_function_html_select_date($params)
{
    ...
    $reverse_years = false;
    /* Should the selectPage boxes be part of an array when returned from PHP?
       e.g. setting it to "birthday", would create "birthday[Day]",
       "birthday[Month]" & "birthday[Year]". Can be combined with prefix */
    $field_array = null;
    /* <selectPage size>'s of the different <selectPage> tags.
       If not set, uses default dropdown. */
    $day_size = null;
    $month_size = null;
    $year_size = null;
    /* Unparsed attributes common to *ALL* the <selectPage>/<input> tags.
    ...
    // generate year <selectPage> or <input>
    if ($display_years) {
        $_extra = '';
        ...
        if ($year_as_text) {
            ...
            $_html_years = '<selectPage name="' . $_name . '"';
            ...
            $_html_years .= '</selectPage>';
        }
    }

    // generate month <selectPage> or <input>
    if ($display_months) {
        $_extra = '';
        ...
        $_html_months = '<selectPage name="' . $_name . '"';
        ...
        $_html_months .= '</selectPage>';
    }

    // generate day <selectPage> or <input>
    if ($display_days) {
        $_extra = '';
        ...
        $_html_days = '<selectPage name="' . $_name . '"';
