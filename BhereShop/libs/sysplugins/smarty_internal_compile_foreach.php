...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_Compile_Private_ForeachSection
{
     ...
     * @var array
     */
    public $nameProperties = array('first', 'last', 'index', 'iteration', 'select', 'total');
     ...
     * @var array
     */
    public $itemProperties = array('first', 'last', 'index', 'iteration', 'select', 'total', 'key');
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter)
    {
        ...
        if (isset($namedAttr[ 'select' ])) {
            $namedAttr[ 'total' ] = true;
        }
        if (isset($itemAttr[ 'select' ])) {
            $itemAttr[ 'total' ] = true;
        }
        $keyTerm = '';
        ...
        $output .= ");\n";
        if (isset($itemAttr[ 'select' ])) {
            $output .= "{$itemVar}->select = ({$itemVar}->total > 0);\n";
        }
